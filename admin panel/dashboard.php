...
<head>
	...
	<title>Fiorello - Admin Dashboard page</title>
		...
		<section class="dashboard">
			...
			<div class="box-container">
				...
				<div class="box">
					...
					<a href="view_active_products.php" class="btn">active product</a>
				</div>
				<div class="box">
					<?php
					...
					<a href="view_deactive_products.php" class="btn">deactive product</a>
				</div>
				<div class="box">
					<?php
				...
				<div class="box">
					...
					<p>sellers account</p>
					<a href="sellers.php" class="btn">see sellers</a>
				</div>
				<div class="box">
					<?php
